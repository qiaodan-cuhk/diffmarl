...
do
    ...
    do
        ...
        do
            ...
            python main.py --env_id $TASK --data_type $types --dataset_num $num --seed $i --device 1 --difftype $difftype --marltype $marltype --critic_load_path $critic_load_path --diffusion_load_path $diffusion_load_path
        done
    done
done
