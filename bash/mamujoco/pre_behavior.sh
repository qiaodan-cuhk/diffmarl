...
do
    ...
    do
        ...
        python /home/qiaodan/code/diffmarl/pretrain_behavior.py --env_id $TASK --data_type $types --device $device --save_interval 10 --srpo_mode $marltype --seq_agent_id $agent_idx &
